...
public class ClientUI extends JFrame implements IClientEvents, ICardControls {
    ...
    public ClientUI(String title) throws IOException {
    ...
    @Override
    public void updateClientPoints(long clientId, String score) {
        chatGamePanel.getChatPanel().updateClientPoints(clientId, score);
    }
    ...
    @Override
    public void updateUserAwayStatus(long clientId, boolean away) {
        chatGamePanel.getChatPanel().updateUserAwayStatus(clientId, away);
    }
